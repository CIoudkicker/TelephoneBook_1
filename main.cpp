...
int main(int argc, char *argv[])
{
    ...
    Contact *con1 = new Contact(1, "dds", "hgf", date("19.12.2004"), date("19.02.2020"));
    Contact *con2 = new Contact(2, "bgf", "bft", date("03.6.2015"), date("02.03.2020"));
    Contact *con3 = new Contact(3, "cfdg", "xsa", date("04.07.2020"), date("13.05.2022"));
    Contact *con4 = new Contact(4, "adgb", "nyf", date("12.08.2021"), date("09.08.2003"));
